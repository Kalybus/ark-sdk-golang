...
import (
	...
	syncpoliciesmodels "github.com/Kalybus/ark-sdk-golang/pkg/models/services/sechub/syncpolicies"
...
// SecHubSyncPoliciesServiceConfig is the configuration for the Secrets Hub Sync Policies service.
var SecHubSyncPoliciesServiceConfig = services.ArkServiceConfig{
...
func (s *ArkSecHubSyncPoliciesService) ServiceConfig() services.ArkServiceConfig {
	return SecHubSyncPoliciesServiceConfig
}
