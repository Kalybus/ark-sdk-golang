...
// SecHubConfigurationServiceConfig is the configuration for the Secrets Hub Configuration service.
var SecHubConfigurationServiceConfig = services.ArkServiceConfig{
...
func (s *ArkSecHubConfigurationService) ServiceConfig() services.ArkServiceConfig {
	return SecHubConfigurationServiceConfig
}
